...
const walletFundProvidusBnkService = require("../services/fundByProvidusBnkServices");
const walletFundNotifications = require("../services/notifications/walletFundNotifications");
...
function  initiateFunding(req, res, next){
    walletFundProvidusBnkService.initiateProvidusBnk(req.body)
    .then((result) => {
        res.json({
...
function validate(req, res, next){
    walletFundProvidusBnkService.validateProvidusBnk(req.body)
    .then((result) => {
...
async function verify(req, res, next){
    walletFundProvidusBnkService.verifyProvidusBnk(req.body)
    .then((results) => {
